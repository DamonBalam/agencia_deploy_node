...
CREATE TABLE `testimoniales` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='tabla para las testimoniales del sitio';
...
INSERT INTO `testimoniales` VALUES (1,'Arturo Saldivar','damonbalam@gmail.com','Unas lindas vacaciones en canada!'),(2,'Jesus Puc','puchepe@gmail.com','Todo Bien!'),(3,'Ricardo Cruz','cruzito@gmail.com','bonito bonito!'),(4,'Melissa Avila','avilame@gmail.com','Muy bonito el viaje a Canada!'),(5,'fakeer','faker@gmail.com','test async/await');
...
CREATE TABLE `viajes` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='tabla para guardar los viajes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-12-15 20:01:19
